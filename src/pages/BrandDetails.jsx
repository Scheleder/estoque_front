          ...
          <div className="mt-2 shadow-lg rounded-md mr-2 p-2 bg-gray-200">
            <div className='grid grid-cols-3 mb-2'>
              ...
              <div className='flex col-span-2'>
                <Input placeholder="Nome" className="bg-white mr-4" value={brand.name} readOnly />
              </div>
              <div className='col-span-1'>
                <Input placeholder="Registro" className="bg-white text-center" value={getDate(brand.createdAt)} readOnly />
              </div>
              <div className='col-span-3 mt-2'>
                <label>Website:</label>
              </div>
              <div className='flex col-span-3'>
                <Input placeholder="Website" className="bg-white" value={brand.website} />
                <Button onClick={handleContact} className="ml-4 bg-purple-500 hover:bg-purple-400"><Earth className='w-5 h-5 mr-2' /> Visitar</Button>
